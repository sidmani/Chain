...
public struct UIViewAnimationOptions : OptionSet {
    ...
    public static var overrideInheritedDuration: UIViewAnimationOptions { get } // ignore nested duration

    public static var overrideInheritedCurve: UIViewAnimationOptions { get } // ignore nested curve

    public static var allowAnimatedContent: UIViewAnimationOptions { get } // animate contents (applies to transitions only)

    public static var showHideTransitionViews: UIViewAnimationOptions { get } // flip to\/from hidden state instead of adding\/removing

    public static var overrideInheritedOptions: UIViewAnimationOptions { get } // do not inherit any options or animation type
    ...
    public static var preferredFramesPerSecond60: UIViewAnimationOptions { get }

    public static var preferredFramesPerSecond30: UIViewAnimationOptions { get }
}

@available(iOS 7.0, *)
public struct UIViewKeyframeAnimationOptions : OptionSet {

    public init(rawValue: UInt)

    
    public static var layoutSubviews: UIViewKeyframeAnimationOptions { get }

    public static var allowUserInteraction: UIViewKeyframeAnimationOptions { get } // turn on user interaction while animating

    public static var beginFromCurrentState: UIViewKeyframeAnimationOptions { get } // start all views from current value, not initial value

    public static var `repeat`: UIViewKeyframeAnimationOptions { get } // repeat animation indefinitely

    public static var autoreverse: UIViewKeyframeAnimationOptions { get } // if repeat, run animation back and forth

    public static var overrideInheritedDuration: UIViewKeyframeAnimationOptions { get } // ignore nested duration

    public static var overrideInheritedOptions: UIViewKeyframeAnimationOptions { get } // do not inherit any options or animation type
    ...
    public static var calculationModeCubicPaced: UIViewKeyframeAnimationOptions { get }
}

@available(iOS 7.0, *)
public enum UISystemAnimation : UInt {
...
public enum UISemanticContentAttribute : Int {
    ...
    case playback // for playback controls such as Play\/RW\/FF buttons and playhead scrubbers

    case spatial // for controls that result in some sort of directional change in the UI, e.g. a segmented control for text alignment or a D-pad in a game
...
extension UIView {
    ...
    @available(iOS 11.0, *)
    open var insetsLayoutMarginsFromSafeArea: Bool // Default: YES
